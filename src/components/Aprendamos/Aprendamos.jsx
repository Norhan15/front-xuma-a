...
import { useAprendamos } from './useAprendamos';
import { EditDialog } from './AprendamosModal/EditDialog';
import { DeleteDialog } from './AprendamosModal/DeleteDialog';
import { AddDialog } from './AprendamosModal/AddDialog';
...
const Aprendamos = () => {
  ...
  const handleCardClick = (categoryId) => {
    navigate(`/aprendamos-categorias/${categoryId}`);
  };
